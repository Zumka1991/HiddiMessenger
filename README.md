...
используют Signal Protocol/PQXDH, а группы с изменяемым составом — общий
Rust/OpenMLS core. Сервер хранит и маршрутизирует только шифротексты; приватные
ключи остаются на клиентских устройствах.
