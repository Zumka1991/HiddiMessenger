...
use uuid::Uuid;
use validation::{
    MAX_ATTACHMENT_BYTES, MAX_JSON_BODY_BYTES, decode_attachment_ciphertext, normalize_device_name,
    normalize_nickname, validate_device_material,
};
...
fn build_app(state: AppState) -> Router {
    api::registration::routes(api::users::routes(Router::new()))
